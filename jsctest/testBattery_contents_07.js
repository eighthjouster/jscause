...
const test_contents_002_jscp_index_large_response_slow_maxtime = Object.assign(makeFromBaseTest('Contents; JSCP file; index; large; slow; max response time exceeded'),
  makeTestEndBoilerplate.call(this),
  {
    // only: true,
    onTestBeforeStart()
...
[
  ...
  test_contents_002_jscp_index_large_response_slow_maxtime
];
