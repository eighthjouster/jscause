...
const test_018_008_processStaticFile_fileNotFound = Object.assign(testUtils.makeFromBaseTest('processStaticFile - file not found'),
  {
    // only: true,
    onTestBeforeStart()
    {
      ...
      // No file is created since we'll test when no file is found.
      this.isUnitTest = true;
    },
    onUnitTestStarted()
    {
      ...
      const maxCachedFilesPerSite = 10;
      const initialCachedStaticFilesSoFar = 1;
      const targetCachedStaticFilesSoFar = initialCachedStaticFilesSoFar;
...
const test_018_009_processStaticFile_fileCannotBeRead = Object.assign(testUtils.makeFromBaseTest('processStaticFile - file cannot be read'),
  {
    // only: true,
    onTestBeforeStart()
    {
      ...
      this.chmodFileOrDir(fullPathComponents, 0o111); // Not readable. Still writable, though.
      this.isUnitTest = true;
    },
    onUnitTestStarted()
    {
    ...
    onTestEnd()
    {
      this.chmodFileOrDir(this.tempTestData.fullPathComponents, 0o755); // Not that we need to do this, but just in case.
    }
  }
);
...
[
  ...
  test_018_008_processStaticFile_fileNotFound,
  test_018_009_processStaticFile_fileCannotBeRead
];
