...
const test_018_005_processStaticFile_maxCachedFilesPerSite_thresholdPassed = Object.assign(testUtils.makeFromBaseTest('processStaticFile - max number of cached files per site; threshold passed; same amount of files'),
  {
    // only: true,
    onTestBeforeStart()
    {
...
const test_018_006_processStaticFile_maxCachedFilesPerSite_thresholdPassed_pt2 = Object.assign(testUtils.makeFromBaseTest('processStaticFile - max number of cached files per site; threshold passed; bigger amount of files'),
  {
    // only: true,
    onTestBeforeStart()
    {
...
module.exports = [
  ...
  test_018_005_processStaticFile_maxCachedFilesPerSite_thresholdPassed,
  test_018_006_processStaticFile_maxCachedFilesPerSite_thresholdPassed_pt2
];
